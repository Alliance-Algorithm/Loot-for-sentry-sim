...
# 克隆仓库
git clone https://github.com/Alliance-Algorithm/rmcs-navigation-mock.git
```
...
- [ ] **高地/起伏路段物理**：上一级台阶（`go-down-onestep.lua` 等 task 已编写但未在 Godot 中完整体现）
- [ ] **起伏路段未搭建**：未在 Godot 中搭建起伏路段
